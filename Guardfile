...
guard :concat, :type => "js", :files => %w[jquery vendor/placeholder vendor/jquery vendor/custom.modernizr vendor/jquery.autocomplete vendor/jquery.cookie vendor/fastclick modernizr foundation/foundation.reveal foundation/foundation.tooltip foundation/foundation.abide foundation/foundation.tab foundation/foundation.accordion foundation/foundation.interchange foundation/foundation.joyride foundation/foundation.magellan foundation/foundation.orbit foundation/foundation.clearing foundation/foundation.dropdown foundation/foundation.topbar foundation/foundation.offcanvas foundation/foundation.alert foundation/foundation], :input_dir => "public/js", :output => "public/js/scripts.min"
